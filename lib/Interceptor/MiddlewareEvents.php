...
namespace FicoScoreInsurance\Client\Interceptor;
...
use \FicoScoreInsurance\Client\Interceptor\KeyHandler;
use \FicoScoreInsurance\Client\Interceptor\MyLogger;
use \FicoScoreInsurance\Client\Model\Errors;
use \FicoScoreInsurance\Client\Model\Error;

class MiddlewareEvents
{
    
    function __construct(\FicoScoreInsurance\Client\Interceptor\KeyHandler $signer)
    {
        $this->signer = $signer;
...
function build_error($code, $message){
    $error = new \FicoScoreInsurance\Client\Model\Error([
        "code" => $code,
        "message" => $message
    ]);
    $errors = new \FicoScoreInsurance\Client\Model\Errores(["errors" => [$error]]);
